...
import { Point2D, SaveData } from "../utility/type";
...
export default class Game {
  ...
  /* タイマー */
  private readonly _mainTimer: NodeJS.Timeout; // メインタイマー
  private readonly _cometTimer: NodeJS.Timeout; // 流星タイマー
  private _shotTimer: NodeJS.Timeout; // 弾タイマー
  private _meteoTimer: NodeJS.Timeout; // 隕石タイマー
